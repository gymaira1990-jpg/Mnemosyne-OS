...
PostgreSQL 16 + pgvector 1024d · Apache AGE 知识图谱 · 豆包 Embedding-Vision · 豆包 Seed-2.0 蒸馏 · DeepSeek V4 审计 · 豆包 cosine 重排序 · FastAPI + asyncpg · GZ 腾讯云 7×24 · SQLite ↔ PG 端云同步
...
所有项目：[your-site.example.com](https://your-site.example.com)
