...
| 版本 | 状态 | 内容 | 日期 |
|---|---|---|---|
| v8.0.0 | 规划中 | **Memory FS 8.0**：把文件系统工程原理补回存储内核（幂等写入/WAL/GC/完整性校验/召回融合）—— 见 `openspec/changes/` | 待定 |
| v7.8.4 | 🧪 仓库已实现·待发布 | 归档质量：收尾汇报/用户消息不再被切 + 工具证据签名 + 短会话不弃 + 汇报卡(worklog) | 2026-09-24 |
