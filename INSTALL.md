...
> ⚠️ 端口当前硬编码为 8010（v7.6.2）。如需换端口，改 `main.py` 最后一行 `port=8010`（环境变量 `MNEMOSYNE_PORT` 暂未生效，下版本修复）。
...
# → {"status":"ok","service":"Mnemosyne OS","version":"7.6.2"}
